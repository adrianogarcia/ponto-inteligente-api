...
//	@Size(min = 5, max = 200, message = "Email deve conter entre 3 e 200 caracteres")
	...
	@Length(min = 5, max = 200, message = "Razão social deve conter entre 3 e 200 caracteres")
	//@Size(min = 5, max = 200, message = "Razão social deve conter entre 3 e 200 caracteres")
